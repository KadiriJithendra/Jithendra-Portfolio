...
export const portfolioCard = [
  {
      ...
      img:chezuba,
      title:"Chezuba",
      description:"Designed a website and graphics that helped attract clients, gaining hands-on experience in web design and branding with a San Francisco based company.",
