  ...
  return (
    <section id="contact" className="py-20 px-4 md:px-20 flex flex-col gap-10">
      ...
      <div className="flex justify-center items gap-10">
        ...
        <div>
          <a href="mailto:jithendrakadiri456@gmail.com" className="transition-colors duration-300">
          </a>
          <a href="https://mail.google.com/mail/?view=cm&fs=1&to=jithendrakadiri456@gmail.com"
